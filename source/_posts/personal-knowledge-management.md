...
description: '探讨基于 Tiago Forte CODE 模型的个人知识管理体系（PKM），如何摆脱「收藏即学会」的陷阱，建立从信息输入、提炼加工到持续高质量输出的复利闭环。'
tags:
  - 个人成长
  - 知识管理
  - 写作
...
2. **Organize（组织）**：按<strong>行动目标与项目（PARA 模型）</strong>进行分类，而非按庞杂宽泛的学科分类；
